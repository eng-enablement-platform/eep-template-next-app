...
<CollapsibleStep title="Open in the container" defaultOpen={true}>
...
<CollapsibleStep title="Set up environment variables" defaultOpen={true}>
...
<CollapsibleStep title="Run migrations and start the server" defaultOpen={true}>
