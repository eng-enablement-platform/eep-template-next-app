---
title: Overview
description: Where things live, how they interact and the "three-layer system"
---

![Architecture diagram](/code/architecture.png)
...
| `app/restricted/`            | Role-based access denial             | Shown when a signed-in user lacks the required role. Lives outside `(app)/` so it can be reached without passing the role check again.                            |
